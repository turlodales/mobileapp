...
@class ShowReportIntentResponse;
...
/*!
 @abstract Handling method - Execute the task represented by the ShowReportIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  intent The input intent
 @param  completion The response handling block takes a ShowReportIntentResponse containing the details of the result of having executed the intent

 @see  ShowReportIntentResponse
 */
- (void)handleShowReport:(ShowReportIntent *)intent completion:(void (^)(ShowReportIntentResponse *response))completion NS_SWIFT_NAME(handle(intent:completion:));
...
/*!
 ...
 @param  intent The input intent
 @param  completion The response block contains a ShowReportIntentResponse containing additional details about the intent that may be relevant for the system to show the user prior to handling.

 @see ShowReportIntentResponse
 */
- (void)confirmShowReport:(ShowReportIntent *)intent completion:(void (^)(ShowReportIntentResponse *response))completion NS_SWIFT_NAME(confirm(intent:completion:));
 ...
 */
typedef NS_ENUM(NSInteger, ShowReportIntentResponseCode) {
    ShowReportIntentResponseCodeUnspecified = 0,
    ShowReportIntentResponseCodeReady,
    ShowReportIntentResponseCodeContinueInApp,
 ...
 */
@property (readonly, NS_NONATOMIC_IOSONLY) ShowReportIntentResponseCode code;
