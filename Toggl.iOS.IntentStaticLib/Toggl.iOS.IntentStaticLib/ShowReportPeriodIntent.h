...
typedef NS_ENUM(NSInteger, ShowReportPeriodReportPeriod) {
    ShowReportPeriodReportPeriodUnknown = 0,
    ShowReportPeriodReportPeriodToday = 1,
    ShowReportPeriodReportPeriodYesterday = 2,
    ShowReportPeriodReportPeriodThisWeek = 3,
...
@class ShowReportPeriodIntentResponse;
...
/*!
 @abstract Handling method - Execute the task represented by the ShowReportPeriodIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  intent The input intent
 @param  completion The response handling block takes a ShowReportPeriodIntentResponse containing the details of the result of having executed the intent

 @see  ShowReportPeriodIntentResponse
 */
- (void)handleShowReportPeriod:(ShowReportPeriodIntent *)intent completion:(void (^)(ShowReportPeriodIntentResponse *response))completion NS_SWIFT_NAME(handle(intent:completion:));
...
/*!
 ...
 @param  intent The input intent
 @param  completion The response block contains a ShowReportPeriodIntentResponse containing additional details about the intent that may be relevant for the system to show the user prior to handling.

 @see ShowReportPeriodIntentResponse
 */
- (void)confirmShowReportPeriod:(ShowReportPeriodIntent *)intent completion:(void (^)(ShowReportPeriodIntentResponse *response))completion NS_SWIFT_NAME(confirm(intent:completion:));
 ...
 */
typedef NS_ENUM(NSInteger, ShowReportPeriodIntentResponseCode) {
    ShowReportPeriodIntentResponseCodeUnspecified = 0,
    ShowReportPeriodIntentResponseCodeReady,
    ShowReportPeriodIntentResponseCodeContinueInApp,
 ...
 */
- (instancetype)initWithCode:(ShowReportPeriodIntentResponseCode)code userActivity:(nullable NSUserActivity *)userActivity NS_DESIGNATED_INITIALIZER;

/*!
 @abstract Initializes and returns the response object with the success code.
 */
+ (instancetype)successIntentResponseWithPeriod:(ShowReportPeriodReportPeriod)period NS_SWIFT_NAME(success(period:));
 ...
 */
@property (readonly, NS_NONATOMIC_IOSONLY) ShowReportPeriodIntentResponseCode code;
