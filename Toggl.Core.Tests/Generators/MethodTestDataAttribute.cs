...
{
    public class MethodTestDataAttribute : DataAttribute
    {
    ...
    public sealed class MethodTestDataTests
    {
        public sealed class TheGeneratedSequence
        {
            private static readonly MethodTestDataAttribute methodTestDataAttribute = new MethodTestDataAttribute();
            ...
            public void ReturnsSequenceWithExactlyOneFalseItem(byte n)
            {
                ...
                var testData = methodTestDataAttribute.GetData(testMethod);
            ...
            public void ReturnsSequenceWithExactlyOneFalseItemForEachParameter(byte n)
            {
                ...
                var testData = methodTestDataAttribute.GetData(testMethod).ToList();
            ...
            private static MethodInfo createMethodWithNParameters(int n)
            {
                ...
                return new DynamicMethod("TestMethod", typeof(void), methodArgs, typeof(MethodTestDataTests).Module);
            }
        }
    }
}
