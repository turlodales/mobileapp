...
namespace Toggl.Networking
{
    internal sealed class TogglApi : ITogglApi
    {
        public TogglApi(ApiConfiguration configuration, IApiClient apiClient)
        {
            ...
            SyncApi = new SyncApi(endpoints, apiClient, serializer, credentials);
            ...
            ExternalCalendars = new ExternalCalendarsApi(endpoints, apiClient, serializer, credentials);
        }
        ...
        public IExternalCalendarsApi ExternalCalendars { get; }
    }
