...
namespace Toggl.iOS
{
    public sealed class PeriscopeView : UIView
    {
        ...
        public override void LayoutSubviews()
        {
            ...
            eyeballLayer.Frame = new CGRect(Bounds.Width * 0.184, Bounds.Height * 0.061, Bounds.Width * 0.203, Bounds.Height * 0.221);
            pupilLayer.Frame = new CGRect(Bounds.Width * 0.230, Bounds.Height * 0.135, Bounds.Width * 0.110, Bounds.Height * 0.109);

            periscopeLayer.RemoveAllAnimations();

            var path = new UIBezierPath();
            path.MoveTo(new CGPoint(Bounds.Width * 0.227, Bounds.Height * 0.176));
            path.AddLineTo(new CGPoint(Bounds.Width * 0.324, Bounds.Height * 0.176));
            path.AddArc(new CGPoint(Bounds.Width * 0.275, Bounds.Height * 0.176), (nfloat)(Bounds.Width * 0.049), 0, (nfloat)Math.PI, true);
            path.ClosePath();
