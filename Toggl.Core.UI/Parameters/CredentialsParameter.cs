...
namespace Toggl.Core.UI.Parameters
{
    public sealed class CredentialsParameter
    {
        ...
        public static CredentialsParameter With(Email email, Password password, bool isForAccountLinking = false)
            => new CredentialsParameter { Email = email, Password = password, IsForAccountLinking = isForAccountLinking };
